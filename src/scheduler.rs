mod scheduler {
  ...
  trait SchedulerDriver {
    ...
    fn request_resources(requestsData: *mut native::ProtobufObj) -> libc::c_int;
...
/*
  impl MesosSchedulerDriver for SchedulerDriver {
    ...
    fn requestResources(requestsData: *mut ProtobufObj) -> libc::c_int;

    fn declineOffer(
      offerId: *mut ProtobufObj,
      filters: *mut ProtobufObj) -> libc::c_int;

    fn killTask(taskId: *mut ProtobufObj) -> libc::c_int;

    fn reviveOffers() -> libc::c_int;

    fn sendFrameworkMessage(
