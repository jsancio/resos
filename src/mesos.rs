...
// Significant portions generated from <project-dir>/src/mesos-c-api.h
...
#[link(name="libmesos")]
extern "C" {
	fn scheduler_launchTasks(driver: *mut libc::c_void, offerId: *mut ProtobufObj, tasks: *mut ProtobufObj, filters: *mut ProtobufObj) -> libc::c_int;
}
...
#[link(name="libmesos")]
extern "C" {
	fn scheduler_start(driver: *mut libc::c_void) -> libc::c_int;
}
...
#[link(name="libmesos")]
extern "C" {
	fn scheduler_stop(driver: *mut libc::c_void, failover: libc::c_int) -> libc::c_int;
}
...
#[link(name="libmesos")]
extern "C" {
	fn scheduler_abort(driver: *mut libc::c_void) -> libc::c_int;
}
...
#[link(name="libmesos")]
extern "C" {
	fn scheduler_join(driver: *mut libc::c_void) -> libc::c_int;
}
...
#[link(name="libmesos")]
extern "C" {
	fn scheduler_run(driver: *mut libc::c_void) -> libc::c_int;
}
...
#[link(name="libmesos")]
extern "C" {
	fn scheduler_requestResources(driver: *mut libc::c_void, requestsData: *mut ProtobufObj) -> libc::c_int;
}
...
#[link(name="libmesos")]
extern "C" {
	fn scheduler_declineOffer(driver: *mut libc::c_void, offerId: *mut ProtobufObj, filters: *mut ProtobufObj) -> libc::c_int;
}
...
#[link(name="libmesos")]
extern "C" {
	fn scheduler_killTask(driver: *mut libc::c_void, taskId: *mut ProtobufObj) -> libc::c_int;
}
...
#[link(name="libmesos")]
extern "C" {
	fn scheduler_reviveOffers(driver: *mut libc::c_void) -> libc::c_int;
}
...
#[link(name="libmesos")]
extern "C" {
	fn scheduler_sendFrameworkMessage(driver: *mut libc::c_void, executor: *mut ProtobufObj, slaveId: *mut ProtobufObj, data: *const libc::c_char) -> libc::c_int;
}
...
#[link(name="libmesos")]
extern "C" {
	fn scheduler_init(callbacks: *mut SchedulerCallbacks, payload: *mut libc::c_void, framework: *mut ProtobufObj, master: *const libc::c_char) -> SchedulerPtrPair;
}
...
#[link(name="libmesos")]
extern "C" {
	fn scheduler_destroy(driver: *mut libc::c_void, scheduler: *mut libc::c_void);
}
...
#[link(name="libmesos")]
extern "C" {
	fn executor_start(driver: *mut libc::c_void) -> libc::c_int;
}
...
#[link(name="libmesos")]
extern "C" {
	fn executor_stop(driver: *mut libc::c_void) -> libc::c_int;
}
...
#[link(name="libmesos")]
extern "C" {
	fn executor_abort(driver: *mut libc::c_void) -> libc::c_int;
}
...
#[link(name="libmesos")]
extern "C" {
	fn executor_join(driver: *mut libc::c_void) -> libc::c_int;
}
...
#[link(name="libmesos")]
extern "C" {
	fn executor_run(driver: *mut libc::c_void) -> libc::c_int;
}
...
#[link(name="libmesos")]
extern "C" {
	fn executor_sendStatusUpdate(driver: *mut libc::c_void, status: *mut ProtobufObj) -> libc::c_int;
}
...
#[link(name="libmesos")]
extern "C" {
	fn executor_sendFrameworkMessage(driver: *mut libc::c_void, data: *const libc::c_char) -> libc::c_int;
}
...
#[link(name="libmesos")]
extern "C" {
	fn executor_init(callbacks: *mut ExecutorCallbacks, payload: *mut libc::c_void) -> ExecutorPtrPair;
}
...
#[link(name="libmesos")]
extern "C" {
	fn executor_destroy(driver: *mut libc::c_void, executor: *mut libc::c_void);
}
...
struct
		...
		scheduler_resourceOffersCallBack_t resourceOffersCallBack [void (*)(void *, ProtobufObj *, int)]
...
struct SchedulerCallbacks {
	registeredCallBack: extern fn(*mut libc::c_void, *mut ProtobufObj, *mut ProtobufObj),
	reregisteredCallBack: extern fn(*mut libc::c_void, *mut ProtobufObj),
	resourceOffersCallBack: extern fn(*mut libc::c_void, *mut ProtobufObj, libc::c_int),
	...
	frameworkMessageCallBack: extern fn(*mut libc::c_void, *mut ProtobufObj, *mut ProtobufObj, *mut ProtobufObj),
	slaveLostCallBack: extern fn(*mut libc::c_void, *mut ProtobufObj),
	executorLostCallBack: extern fn(*mut libc::c_void, *mut ProtobufObj, *mut ProtobufObj, libc::c_int),
...
struct ExecutorCallbacks {
	registeredCallBack: extern fn(*mut libc::c_void, *mut ProtobufObj, *mut ProtobufObj, *mut ProtobufObj),
	reregisteredCallBack: extern fn(*mut libc::c_void, *mut ProtobufObj),
	disconnectedCallBack: extern fn(*mut libc::c_void),
