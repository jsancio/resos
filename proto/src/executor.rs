...
pub struct Call_Subscribe {
    // message fields
    tasks: ::protobuf::RepeatedField<super::mesos::TaskInfo>,
...
impl Call_Subscribe {
    ...
    // Param is passed by value, moved
    pub fn set_tasks(&mut self, v: ::protobuf::RepeatedField<super::mesos::TaskInfo>) {
        self.tasks = v;
    }

    // Mutable pointer to the field.
    pub fn mut_tasks<'a>(&'a mut self) -> &'a mut ::protobuf::RepeatedField<super::mesos::TaskInfo> {
        &mut self.tasks
    }

    // Take field
    pub fn take_tasks(&mut self) -> ::protobuf::RepeatedField<super::mesos::TaskInfo> {
        ::std::mem::replace(&mut self.tasks, ::protobuf::RepeatedField::new())
    }

    pub fn get_tasks<'a>(&'a self) -> &'a [super::mesos::TaskInfo] {
        &self.tasks
    }
